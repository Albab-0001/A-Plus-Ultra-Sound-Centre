...
export function LampDemo() {
  return (
    <LampContainer>
      ...
      >
               Your health is our priority. <br /> Fully Computerized Pathology Lab <br />   Advanced diagnostic imaging with cutting-edge technology and experienced professionals.
      </motion.h1>
    </LampContainer>
  );
}
